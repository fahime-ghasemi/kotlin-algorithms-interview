/**
 * You are given an array of Ints and a target value.
 * What you should do is return two values from the given array where sum of them is equal to target value
 */
package easy
fun main()
{
